...
internal class ComponentsTest {
    ...
    fun handlesIp4Buffers() {
        val actual = Ip4Component.bytesToComponent(Protocol.IP4, Hex.decode("c0a80001").expectNoErrors()).expectNoErrors()
        assertEquals("/ip4/192.168.0.1", actual.toString())
    }

    @Test
    fun handlesIp6Buffers() {
        val actual = Ip6Component.bytesToComponent(Protocol.IP4, Hex.decode("abcd0000000100020003000400050006").expectNoErrors()).expectNoErrors()
    ...
    fun throwsOnInvalidIp4Conversion() {
        assertErrorResult("Invalid IPv4 address: 555.168.0.1") { Ip4Component.stringToComponent(Protocol.IP4, "555.168.0.1") }
    }

    @Test
    fun throwsOnInvalidIp6Conversion() {
        assertErrorResult("Invalid IPv6 address: FFFF::GGGG") { Ip6Component.stringToComponent(Protocol.IP6, "FFFF::GGGG") }
    }
